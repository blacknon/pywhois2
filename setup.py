...
def get_data_files():
    ...
    # 対象となるファイルをdict形式で指定
    # files = dict(
    #     bash=['completion/pywhois2-completion.bash'],
    #     zsh=[
    #         'completion/pywhois2-completion.bash',
    #         'completion/_pywhois2'
    #     ]
    # )
    ...
    # data
    # data_files.append(('data', ['data/data.yml']))

    # templates
    # data_files.append(('templates', 'template/*.ttp'))
